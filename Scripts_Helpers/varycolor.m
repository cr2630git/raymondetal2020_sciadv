...
% VARYCOLOR Produces maximally varying colors for a certain number of lines or other objects to be plotted plots
%
...
elseif NumberOfPlots==6
    ...
    %This is to deal with the extra plots that don't fit nicely into the segments
    Adjust=zeros(1,5);
    for m=1:ExtraPlots
        Adjust(m)=1;
    end
